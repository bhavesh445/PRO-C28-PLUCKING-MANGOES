...
function setup() {
	...
	dground=new Ground();
	stones=new Stone(100,460,155);
	mango1=new Mango(600,290,155);
  mango2=new Mango(855,325,155);
	mango3=new Mango(670,260,155);
	mango4=new Mango(730,200,155);
	mango5=new Mango(710,320,155);
	mango6=new Mango(780,250,155);
	mango7=new Mango(825,170,155);
	mango8=new Mango(880,260,155);
	mango9=new Mango(940,220,155);
  mango10=new Mango(980,305,150);
